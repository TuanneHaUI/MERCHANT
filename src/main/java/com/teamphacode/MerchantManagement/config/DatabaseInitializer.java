...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (countPermissions == 0) {
            ...
            arr.add(new Permission("Install sample excel", "/api/v1/merchant/export/sample", "GET", "excel-controller"));
            arr.add(new Permission("Export data excel", "/api/v1/merchant/export/excel", "GET", "excel-controller"));
            arr.add(new Permission("Read to excel form databsae", "/api/v1/merchant/import/upload", "POST", "excel-controller"));
